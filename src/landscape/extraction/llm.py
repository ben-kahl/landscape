...
_SYSTEM_PROMPT = (
    ...
    "emit `effective_from` and/or `effective_until` as ISO-8601 dates on the relation\n"
    "itself. Examples:\n"
    "- \"Alice has worked at Acme since March 2024\" → effective_from: \"2024-03\"\n"
    "- \"Alice started/joined/began at Acme in March 2024\" → effective_from: \"2024-03\"\n"
    "- \"Bob led Sentinel from Q1 2023 to Q3 2024\" → effective_from: \"2023-01\","
    " effective_until: \"2024-09\"\n"
    "- \"Carol left Initech in 2022-08\" → on the prior employment relation,"
    " effective_until: \"2022-08\"\n"
    "- \"Dan worked at Globex from 2019 onward\" → effective_from: \"2019\"\n"
    ...
    "\n"
    "IMPORTANT: When you emit `effective_from` or `effective_until` on a relation, do\n"
    "NOT also emit a separate HAPPENED_ON relation pointing at that same date. The\n"
    "date belongs ON the relation it qualifies, not as its own edge. \"Alice joined\n"
    "Acme in 2024-03\" produces ONE WORKS_FOR relation with effective_from=\"2024-03\",\n"
    "NOT a WORKS_FOR plus a HAPPENED_ON.\n"
    "\n"
